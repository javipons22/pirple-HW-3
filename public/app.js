    ...
    app.client.request(undefined, 'api/tokens', 'PUT', undefined, payload, function (statusCode, responsePayload) {
      ...
      if (statusCode == 200) {
        ...
        app.client.request(undefined, 'api/tokens', 'GET', queryStringObject, undefined, function (statusCode, responsePayload) {
          // Display an error on the form if needed
          if (statusCode == 200) {
            // esponsePayload Example
            //{
            //  "email": "prueba@mail.com",
            //  "id": "vtu1ix0ki68d5i7g7b37",
            //  "expires": 1558469583432
            //}
            app.setSessionToken(responsePayload);
            callback(false);
          } else {
...
app.loadOrdersCreatePage = function () {
  // Get email from session token object to pass it as a hidden value in form
  var email = typeof (app.config.sessionToken.email) == 'string' ? app.config.sessionToken.email : false;
  // The hidden Email input is in the ordersCreate.html file , we just add this email value to it
  var hiddenEmailInput = document.querySelector("input.hiddenEmailAddressInput");
